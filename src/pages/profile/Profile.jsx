  ...
  useEffect(() => {
    const GetData = async () => {
      const resq = await axios.get(
        "https://meme-api-26tc.onrender.com/api/users/data",
  ...
  const UpdateProfile = async (e) => {
    ...
    try {
      ...
      const resq = await axios.put(
        "https://meme-api-26tc.onrender.com/api/users/update/profile",
        data,
        { withCredentials: true }
      );
      console.log(resq);
  ...
  const UpdateNewPassword = async (e) => {
    ...
    try {
      ...
      const dat = await axios.put(
        "https://meme-api-26tc.onrender.com/api/users/update/pass",
        pass,
        { withCredentials: true }
      );
                ...
                <form className="prof">
                  ...
                  <div className="buttons">
                    ...
                    <button onClick={UpdateProfile}>
                      {load ? (
                        <img className="load" src={loading} alt="" />
                      ) : (
                        "Update"
                      )}
                    </button>
